import{s as a,i as m,u as y,t as d,e as b,g as v}from"./page-dashboard-Dbqm2OjXb.js";import{m as l,u as h}from"./page-lancamentos-BfWtlLw7b.js";import"./supabase-DthfXWp1.js";let s=null;const p=["#2563eb","#16a34a","#dc2626","#d97706","#7c3aed","#0891b2","#be185d","#92400e","#065f46","#1e40af"];function w(e){return p[e.length%p.length]}async function E(){try{const e=await m("negocios"),i=y("negocios",e);a.set("negocios",i)}catch(e){d.err("Erro ao carregar negócios: "+e.message)}u()}function u(){var i;if(!s)return;const e=(a.get("negocios")??[]).sort((o,r)=>(o.nome||"").localeCompare(r.nome||"","pt-BR"));s.innerHTML=`
