import{s as n,i as f,u as x,t as s,e as m,g as v}from"./page-dashboard-Dbqm2OjXbF1.js";import{m as l,u as b}from"./page-lancamentos-BfWtlLw7bF1.js";import"./supabase-DthfXWp1F1.js";let d=null;async function y(){try{const e=await f("categorias"),t=x("categorias",e);n.set("categorias",t)}catch(e){s.err("Erro ao carregar categorias: "+e.message)}p()}function p(){var t;if(!d)return;const e=(n.get("categorias")??[]).sort((a,r)=>(a.nome||"").localeCompare(r.nome||"","pt-BR"));d.innerHTML=`
