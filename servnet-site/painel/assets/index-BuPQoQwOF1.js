...
import{_ as y}from"./app-CkIaDDomF1.js";import{s as d,f as u,b as h,i as w,u as $,t as l,e as j,g as z,h as x}from"./page-dashboard-Dbqm2OjXbF1.js";import{m as c,u as k}from"./page-lancamentos-BfWtlLw7bF1.js";import"./modulepreload-polyfill-B5Qt9EMXF1.js";import"./auth-8dcbKywjF1.js";import"./supabase-DthfXWp1F1.js";let p=null;async function E(){try{const t=await w("ajustes");d.set("ajustes",$("ajustes",t))}catch(t){l.err("Erro ao carregar ajustes: "+t.message)}f()}async function m(){if(d.get("contas"))return;const{fetchAll:t,unpack:o}=await y(async()=>{const{fetchAll:n,unpack:a}=await import("./page-dashboard-Dbqm2OjXbF1.js").then(e=>e.m);return{fetchAll:n,unpack:a}},__vite__mapDeps([0,1]));d.set("contas",o("contas",await t("contas")))}function f(){var a;if(!p)return;const t=d.get("contas")??[],o=[...d.get("ajustes")??[]].sort((e,r)=>(r.data||"").localeCompare(e.data||"")),n=o.reduce((e,r)=>e+(Number(r.valor)||0),0);p.innerHTML=`
