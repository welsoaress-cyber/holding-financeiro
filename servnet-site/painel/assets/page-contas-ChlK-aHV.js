import{s,f as u,i as m,u as g,t as d,e as y,g as b}from"./page-dashboard-Dbqm2OjXb.js";import{m as p,u as h}from"./page-lancamentos-BfWtlLw7b.js";import"./supabase-DthfXWp1.js";let l=null;const $=["Conta Corrente","Conta Poupança","Conta Pagamento","Carteira","Investimento","Outro"];async function w(){try{const e=await m("contas"),n=g("contas",e);s.set("contas",n)}catch(e){d.err("Erro ao carregar contas: "+e.message)}f()}function c(e){return Number(e.saldoInicial??e.saldo)||0}function z(e){if(e.parentId)return"";const n=c(e),a=n>=0?"#059669":"#dc2626",i=e.instituicao??e.banco??"",t=e.ativa===!1,r=(s.get("contas")??[]).filter(o=>o.parentId===e.id);return`
