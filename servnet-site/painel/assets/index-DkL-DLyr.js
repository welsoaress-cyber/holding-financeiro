const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-dashboard-Dbqm2OjX.js","assets/supabase-DthfXWp1.js"])))=>i.map(i=>d[i]);
import{_ as q}from"./app-CkIaDDom.js";import{s,f as I,a as L,u as M,t as p,N as T,b as O,e as N,g as j,h as z}from"./page-dashboard-Dbqm2OjX.js";import{m as b,u as C}from"./page-lancamentos-BfWtlLw7.js";import"./modulepreload-polyfill-B5Qt9EMX.js";import"./auth-8dcbKywj.js";import"./supabase-DthfXWp1.js";let l=null,f=new Date().getFullYear(),d=new Date().getMonth()+1,m=null,w=!1,h=!1;function A(){return`${f}-${String(d).padStart(2,"0")}`}function k(){return`${T[d-1]} de ${f}`}function F(){d--,d<1&&(d=12,f--),m=null,y(!0)}function P(){d++,d>12&&(d=1,f++),m=null,y(!0)}async function y(e=!1){if(!h){h=!0;try{const{items:t,hasMore:r,lastId:a}=await L("lancamentos","*",{cursor:e?null:m,limit:200,filtros:{"dados->>mes_ref":A(),"dados->>tipo":"transferencia"}}),n=M("lancamentos",t);e?s.set("transferencias",n):s.set("transferencias",[...s.get("transferencias")??[],...n]),m=a,w=r}catch(t){p.err("Erro ao carregar transferências: "+t.message)}finally{h=!1,v()}}}async function S(){if(s.get("contas"))return;const{fetchAll:e,unpack:t}=await q(async()=>{const{fetchAll:r,unpack:a}=await import("./page-dashboard-Dbqm2OjX.js").then(n=>n.m);return{fetchAll:r,unpack:a}},__vite__mapDeps([0,1]));s.set("contas",t("contas",await e("contas")))}function v(){var o,u,x,c;if(!l)return;const e=s.get("transferencias")??[],t=s.get("contas")??[],r=e.reduce((i,g)=>i+(Number(g.valor)||0),0),a=new Date,n=f===a.getFullYear()&&d===a.getMonth()+1;l.innerHTML=`
